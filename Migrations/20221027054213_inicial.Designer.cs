...
namespace Optica.Migrations
{
    ...
    [Migration("20221027054213_inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Optica.Models.Citas", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Optica.Models.Contactanos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Optica.Models.Productos", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Optica.Models.Proforma", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Optica.Models.Proforma", b =>
                {
                    b.HasOne("Optica.Models.Productos", "Producto")
